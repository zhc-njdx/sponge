 ...
 * 3.make sure read and print all the output from the server until the socket reaches "EOF", a single call to read is
 * not enough 4.expect to write about ten lines of code
 * ----------------------------------------------------------
 *
 * */
